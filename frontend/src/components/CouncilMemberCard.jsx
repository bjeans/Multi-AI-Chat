    ...
    <div className="card">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-2">
          <h3 className="font-semibold text-lg truncate" title={modelId}>
            {modelId}
          </h3>
          {isChairman && (
      ...
      <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-3 min-h-[150px] max-h-[400px] overflow-y-auto">
