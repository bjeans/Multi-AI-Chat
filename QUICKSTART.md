...
- [x] LiteLLM proxy running at `https://litellm.home.jeans.family/`
...
- Check that `https://litellm.home.jeans.family/` is accessible
- Verify the URL in `backend/.env`
- Test with: `curl https://litellm.home.jeans.family/models`
...
```
LITELLM_PROXY_URL=https://litellm.home.jeans.family
